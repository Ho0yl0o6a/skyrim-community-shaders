...
namespace RemixBridge
{
	namespace
	{
		...
		bool Initialize()
		{
			...
			// Keep the first test independent of game materials, illumination and camera extraction.
			...
			api.SetConfigVariable("rtx.debugView.debugViewIdx", "32");
